                ...
                <tr>
                    <td height="510" valign="top" style="padding:5px;">
                        <table width="98%" height="487" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td height="22" valign="top" class="word_orange">Quản lý thư viện&gt;&gt;&gt;</td>
                            </tr>
                            <tr>
                                <td align="center" valign="top">
                                    ...
                                    <form name="form1" method="post" action="library?action=libraryModify">
                                        <table width="58%" border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr align="center">
                                                <td width="20%" align="left" style="padding:5px;">Tên thư viện：</td>
                                                <td width="80%" align="left">
                                                    <input name="libraryname" type="text" id="libraryname"
                                                           value="${lf.libraryName }" size="30">

                                                </td>
                                            <tr>
                                                <td align="left" style="padding:5px;">Người phụ trách：</td>
